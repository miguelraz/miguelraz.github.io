...
**** HOLD SIMD course with Lemire papers?
***** HOLD Uwu in Julia
...
*** PROJ [#B] Denis Bakhalov PerfNinja Course in Julia :courses:
*** Partial SGJ Course
...
****
*** PROJ Tim Davis Sparse matrix :courses:
*** PROJ BLIS course in Julia :courses:
*** NLAlgebra course
